...
const CountryStatistics = ({
    ...
    return (
        <div>
            {currentCountry ?
                <div><h3>Current stats for {listOfCountries[currentCountry]}</h3> {loadingCurrent ? <div>loading...</div> : currentData[currentCountry] ? <div>Total confirmed cases: {currentData[currentCountry].confirmed}</div>
